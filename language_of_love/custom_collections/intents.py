class Intents:
    ...
    # Samples phrases : 'stop language of love', 'please stop', 'bill please', 'quit', 'stop', 'I want to leave', 'end my date', 'cheque please', 'check please', 'I am leaving this date', 'I don't like my date'
    ...
    # Samples phrases : 'can you play any instrument', 'favourite music genre', 'what is your favourite music genre', 'name your hero', 'favourite animation', 'favourite movie', 'favourite film', 'favourite animation movie', 'favourite movie genre', 'what is your favourite movie genre', 'who is your favourite celebrity', 'favourite celebrity', 'favourite actress', 'favourite actor', 'who is your favourite actress', 'who is your favourite actor', 'who was your hero', 'who is your hero', 'what's your superpower', 'what kind of superpower would you like to have', 'if you could have a superpower what would it be', 'what is your favourite movie', 'are you an early morning person', 'are you a night owl', 'are you a night person', 'are you a morning or night person', 'are you a morning person', 'what is your favourite season', 'What is your favourite month of the year'
    QUESTION_TASTE_PREFERENCES = 'QuestionTastePreferencesIntent'
    ...
    ANSWER_FAVOURITE_COLOUR = 'AnswerFavouriteColourIntent'
    ...
    ANSWER_HOW_DAY = 'AnswerHowDayIntent'

    # Samples phrases : 'are you an alcoholic', 'do you go clubbing', 'do you like to party', 'do you like alcohol', 'do you drink'
    QUESTION_DRINK = 'QuestionDrinkIntent'

    # Samples phrases : 'i love drinking ', 'i love wine', 'i love beer'
    ANSWER_DRINK = 'AnswerDrinkIntent'
